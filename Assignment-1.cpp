...
int main()
{
    ...
    cout << "Display with intials of Family Head First\n"
         << endl;
    ...
    cout << '\n'
         ...
         << endl
         << endl;
    cout << "Display with initials of Family Junior First\n"
         << endl;
...
Ans. We can do so by having the linked list sort in either ascending or descending order by age so that family members come in a particular order.
*/