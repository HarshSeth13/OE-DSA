...
void bubble_sort(int arr[],int n){  // Implementing Bubble Sort Algorithm
    int i=0,j=1,t=n-1;
    int no_of_swap=0;
    int no_of_comp=0;
    while(t>0){
...
int min_ind(int arr[],int si,int ei){          //Function that returns index of minimum value in an array
...
void selection_sort(int arr[],int n){   //Implementing Selection-Sort Algorithm
    //si=starting index  
    //ei=ending index
    int si=0,ei=n-1;
    int no_of_swap=0;
...
int main(){
    ...
    cout<<"\nARRAY before sorting:";print(arr1,n);
    cout<<endl;
    //sorting array using bubble sort and printing it
    cout<<"BUBBLE SORT"<<endl;
    bubble_sort(arr1,n);
    cout<<" . ARRAY After Sorting Using Bubble Sorting:";print(arr1,n);
    cout<<endl;
    //sorting array using insertion sort and printing it
    cout<<"SELECTION SORT"<<endl;
    selection_sort(arr2,n);
    cout<<" . ARRAY After Sorting Using Selection Sorting:";print(arr2,n);
}
/*
